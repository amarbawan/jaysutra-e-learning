...
<section class="showcase">
  <div class="container">
    <div class="pb-2 mt-4 mb-2 border-bottom">
      <h2>JaySutra Education Payment Gateway</h2>
    </div>
...
<script type="text/javascript">
  jQuery(document).on('click', '#razor-pay-now', function (e) {
    ...
    var store_name = 'JaySutra Education';
    var store_description = 'One Sutra For All Problems!';
    var store_logo = 'https://jaysutra.com/home_assets/img/logo.png';
